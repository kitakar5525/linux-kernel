...
/* v1p8sx regulator */
static struct regulator_init_data xiaomi_mipad2_v1p8sx_data = {
	.constraints = {
		.min_uV = 1620000,
		.max_uV = 1980000,
	...
	.num_consumer_supplies	= ARRAY_SIZE(xiaomi_mipad2_v1p8sx_consumer),
	.consumer_supplies	= xiaomi_mipad2_v1p8sx_consumer,
};

/* v2p8sx regulator */
static struct regulator_init_data xiaomi_mipad2_v2p8sx_data = {
	.constraints = {
		.min_uV			= 2565000,
		.max_uV			= 3300000,
	...
	.num_consumer_supplies	= ARRAY_SIZE(xiaomi_mipad2_v2p8sx_consumer),
	.consumer_supplies	= xiaomi_mipad2_v2p8sx_consumer,
};
/* 1v2psx regulator */
static struct regulator_init_data xiaomi_mipad2_v1p2sx_data = {
	.constraints = {
		.min_uV			= 1200000,
		.max_uV			= 1200000,
		.valid_ops_mask		= REGULATOR_CHANGE_STATUS,
	...
	.num_consumer_supplies	= ARRAY_SIZE(xiaomi_mipad2_v1p2sx_consumer),
	.consumer_supplies	= xiaomi_mipad2_v1p2sx_consumer,
};


static struct regulator_init_data xiaomi_mipad2_vprog4d_data = {
	.constraints = {
		.min_uV			= 2800000,
		.max_uV			= 2800000,
		.valid_ops_mask		= REGULATOR_CHANGE_STATUS,
	...
	.num_consumer_supplies	= ARRAY_SIZE(xiaomi_mipad2_vprog4d_consumer),
	.consumer_supplies	= xiaomi_mipad2_vprog4d_consumer,
};
...
*
*************************************************************/
static struct regulator_init_data wcove_xiaomi_mipad2_v1p8sx_data;
static struct regulator_init_data wcove_xiaomi_mipad2_v2p8sx_data;
static struct regulator_init_data wcove_xiaomi_mipad2_v1p2sx_data;
static struct regulator_init_data wcove_xiaomi_mipad2_vprog4d_data;

static struct wcove_regulator_info wcove_xiaomi_mipad2_v1p8sx_info = {
	.init_data = &wcove_xiaomi_mipad2_v1p8sx_data,
};

static struct wcove_regulator_info wcove_xiaomi_mipad2_v2p8sx_info = {
	.init_data = &wcove_xiaomi_mipad2_v2p8sx_data,
};

static struct wcove_regulator_info wcove_xiaomi_mipad2_v1p2sx_info = {
	.init_data = &wcove_xiaomi_mipad2_v1p2sx_data,
};

static struct wcove_regulator_info wcove_xiaomi_mipad2_vprog4d_info = {
	.init_data = &wcove_xiaomi_mipad2_vprog4d_data,
};

static void xiaomi_mipad2_wc_set_v1p8_pdata(void)
{
	memcpy((void *)&wcove_xiaomi_mipad2_v1p8sx_data, (void *)&xiaomi_mipad2_v1p8sx_data,
			sizeof(struct regulator_init_data));

	intel_soc_pmic_set_pdata("wcove_regulator", &wcove_xiaomi_mipad2_v1p8sx_info,
		sizeof(struct wcove_regulator_info), WCOVE_ID_V1P8SX + 1);

}

static void xiaomi_mipad2_wc_set_v2p8_pdata(void)
{
	memcpy((void *)&wcove_xiaomi_mipad2_v2p8sx_data, (void *)&xiaomi_mipad2_v2p8sx_data,
			sizeof(struct regulator_init_data));

	/* register camera regulator for whiskey cove PMIC */
	intel_soc_pmic_set_pdata("wcove_regulator", &wcove_xiaomi_mipad2_v2p8sx_info,
		sizeof(struct wcove_regulator_info), WCOVE_ID_V2P8SX + 1);
}

static void xiaomi_mipad2_wc_set_v1p2_pdata(void)
{
	memcpy((void *)&wcove_xiaomi_mipad2_v1p2sx_data, (void *)&xiaomi_mipad2_v1p2sx_data,
			sizeof(struct regulator_init_data));

	/* register camera regulator for whiskey cove PMIC */
	intel_soc_pmic_set_pdata("wcove_regulator", &wcove_xiaomi_mipad2_v1p2sx_info,
		sizeof(struct wcove_regulator_info), WCOVE_ID_V1P2SX + 1);
}

static void xiaomi_mipad2_wc_set_vprog4d_pdata(void)
{
	memcpy((void *)&wcove_xiaomi_mipad2_vprog4d_data, (void *)&xiaomi_mipad2_vprog4d_data,
			sizeof(struct regulator_init_data));

	/* register camera regulator for whiskey cove PMIC */
	intel_soc_pmic_set_pdata("wcove_regulator", &wcove_xiaomi_mipad2_vprog4d_info,
...
static int whiskey_cove_init(void)
{
	...
	wc_set_adc_pdata();
	wc_set_gpio_pdata();
	xiaomi_mipad2_wc_set_v1p8_pdata();
	xiaomi_mipad2_wc_set_v2p8_pdata();
	xiaomi_mipad2_wc_set_v1p2_pdata();
	xiaomi_mipad2_wc_set_vprog4d_pdata();
