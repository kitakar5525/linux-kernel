...
static struct v4l2_mbus_framefmt *__csi2_get_format(
	struct atomisp_mipi_csi2_device *csi2, struct v4l2_subdev *sd,
	...
	struct v4l2_subdev_state *sd_state, struct v4l2_subdev_format *fmt)
{
	...
	format = __csi2_get_format(csi2, sd, sd_state, fmt->which, fmt->pad);
			  ...
			  struct v4l2_mbus_framefmt *ffmt)
{
	...
	struct v4l2_mbus_framefmt *actual_ffmt =
		__csi2_get_format(csi2, sd, sd_state, which, pad);
	...
	*actual_ffmt = *ffmt =
		*__csi2_get_format(csi2, sd, sd_state, which, CSI2_PAD_SINK);
